        ...
        <template v-for="(item, i) of navigatorDataas">
            <div class="navi-item" :key="i" v-if="!item.isHide">
                ...
                <transition name="fade">
                    <div class="sub-navi-wrap" v-show="item.showChildren && item.children.length" :class="`width-mode-${item.lineNum}`" :style="`width: ${item.width}`">
                ...
                if(menu.href){
                    ...
                    if(menu.href){
                        ...
                        if(menu.prop && menu.prop.type) {
                            this.$router.push({path: menu.href, query: {type: menu.prop.type}});
                        } else {
